...
# ================= TICKER BAR v0.2.0 =================
# v0.2.0: Updated tip text for iota->particle, mote->iota, particle->mote rename.
...
var ticker_items: Array = [
    ...
    {"type": "tip",   "text": "Compress 5 Tetrads into a Particle. Type doesn't matter — quantity does."},
