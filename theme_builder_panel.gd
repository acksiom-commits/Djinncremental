extends Node
# ================= DJINNCREMENTAL THEME BUILDER v0.2.0 =================
# Run this script once to generate djinncremental_theme.tres
# Attach to TempPanel, run the scene, then detach the script.
#
...
func _ready() -> void:
    build_theme()
    print("Theme built and saved. Detach this script from TempPanel now.")
...
func build_theme() -> void:
    ...
    theme.set_font_size("normal_font_size", "RichTextLabel", 16)  # was 14
